...
@fig-dist-bag-ep-online shows that both the BAG and the EP-Online data set have a very similar distribution of dwellings across all construction year periods.
...
![Spreiding van woningen per bouwperiode in de BAG en in de EP-Online gegevens](images/bouwperiode_dist.png){#fig-dist-bag-ep-online}
