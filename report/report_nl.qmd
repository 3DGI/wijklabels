...
We concluderen dat de geregistreerde gebouwen in de EP-Online (@Rijksoverheid_EP_2023) de spreiding van de BAG volgen wat betreft bouwjaar en woningtype. De datapunten in de EP-Online representeren de BAG dicht genoeg, zodat we de resultaten van onze validatie, die we berekenen op basis van alleen de gebouwen die in de EP-Online staan, kunnen generaliseren.
...
De nauwkeurigheid van de schatting in met één labelafwijking is **51%**. De nauwkeurigheid van de schatting met één labelafwijking voor eengezinswoningen is **58%**.
...
De nauwkeurigheid van de schatting in met één labelafwijking is **65%**. De nauwkeurigheid van de schatting met één labelafwijking voor eengezinswoningen is **70%**.

Verder laat de @fig-dist-bar-eengezins-possible zien dat de labels van B en beter worden onderschat en die van C en slechter worden overschat.
...
Zowel de hele set geschatte labels (@fig-dist-bar) als de mogelijke set labels (@fig-dist-bar-eengezins-mogelijk) laten zien dat onze methode de labels B en beter onderschat, en de labels C en slechter overschat. Dezelfde trend kan worden gezien in @fig-nl-dist. Een plausibele verklaring zijn de pas gerenoveerde woningen, die energetische verbeteringen hebben waar onze methode geen rekening mee kan houden.
De NTA8800 energielabels in de EP-Online (@Rijksoverheid_EP_2023) database zijn voldoende representatief om gebruikt te worden als validatieset voor de ontwikkeling van landelijke methoden voor het schatten van energielabels. 
...
Tot slot laten onze resultaten zien dat de gaten in de energielabel spreidingen van de Voorbeeldwoningen 2022 (@RVO_Voorbeeldwoningen_2022), en de onjuiste schatting van woningsubtypen een significante invloed hebben op de nauwkeurigheid van de geschatte labels (zie @sec-only-possible). Op basis van de EP-Online (@Rijksoverheid_EP_2023) data kunnen we stellen dat 32% van de geschatte labels fout is door onvolledige spreidingen in de studie Voorbeeldwoningen 2022 (@RVO_Voorbeeldwoningen_2022). Dit zorgt bovendien voor een verdubbeling van de gemiddelde labelafwijking in onze resultaten.
De mogelijke labels {#sec-only-possible} laten een 10% hogere nauwkeurigheid zien met een volledige energielabelspreiding, van 21% naar 32%.
De eengezinswoningen hebben een significant hogere classificatienauwkeurigheid (87%) dan de meergezinswoningen (26%). Een correcte classificatie van woningen verbetert de nauwkeurigheid dus nog verder, met ongeveer één procent. De meergezinswoningen vormen 44% van onze resultaten.
Door de validatiecriteria te versoepelen en één labelafwijking in de schattingen toe te staan, met volledige energielabelverdelingen en correcte woningtypen, lijkt een nauwkeurigheid van 70% mogelijk. We beschouwen deze nauwkeurigheid als de bovengrens van onze methode.
...
- De onvolledige energielabelverdelingen van Voorbeeldwoningen 2022 (@RVO_Voorbeeldwoningen_2022) hebben de grootste invloed op de labelschatting. Daarom raden we aan om de volledigheid van de energielabelverdelingen te verbeteren.
- De subwoningtypes hebben ook een significante invloed op de resultaten en appartementen maken ongeveer 44% van de woningen uit. Daarom bevelen we twee verbeterpunten aan:
  - Gebruik de nieuwe, NTA8800 appartamenttypen voor de energielabelverdelingen van de Voorbeeldwoningen studie. Hiermee zou het omzetten van woningtypen vermeden kunnen worden.
  - Verbeter de methode voor de classificatie van het subtype appartement.
