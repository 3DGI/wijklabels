...
Zowel de hele set geschatte labels (@fig-dist-bar) als de mogelijke set labels (@fig-dist-bar-eengezins-possible) laten zien dat onze methode de labels B en beter onderschat, en de labels C en slechter overschat. Dezelfde trend kan worden gezien in @fig-nl-dist. Een plausibele verklaring zijn de pas gerenoveerde woningen, die energetische verbeteringen hebben waar onze methode geen rekening mee kan houden.
