...
def join_with_ep_online(estimated_labels_csv_path: Path,
    ...
    estimated_labels = pd.read_csv(estimated_labels_csv_path).set_index(["vbo_identificatie", "pand_identificatie"])
...
parser_validate.add_argument('--plot', type=str, help="Produce a diagram for each neighborhood, comparing the estimated labels to the EP-Online labels. The diagrams are placed into the provided directory.")
